...
namespace SecretAlliances
{
    ...
    public class SubModule : MBSubModuleBase
    {
        ...
        protected override void OnSubModuleLoad()
        {
            ...
            // Use the current API: Create + Register(Assembly)
            _uiExtender = UIExtender.Create("SecretAlliances");
            _uiExtender.Register(typeof(SubModule).Assembly); // Registers mixins + prefab extensions from this assembly
            _uiExtender.Enable();
        }
        ...
        protected override void OnGameStart(Game game, IGameStarter starterObject)
        {
            ...
            if (starterObject is CampaignGameStarter campaignStarter)
            {
                ...
                // Optional: allow opening via hotkey on campaign map
                campaignStarter.AddBehavior(new SecretAlliancesUiBehavior());

                InformationManager.DisplayMessage(new InformationMessage(
                    "Secret Alliances v2.0 loaded ",
        ...
        // Your existing RegisterDialogs(...) and other members remain unchanged
...
private void RegisterDialogs(CampaignGameStarter starter)
        ...
        private bool ShouldAcceptAlliance()
        {
            ...
            return _currentAllianceEvaluationScore > 0; // Threshold for acceptance
        }
