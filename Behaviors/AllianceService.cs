...
namespace SecretAlliances.Behaviors
{
    ...
    public class AllianceService : CampaignBehaviorBase
    {
        ...
        public override void RegisterEvents()
        {
            ...
            CampaignEvents.ClanDestroyed.AddNonSerializedListener(this, OnClanDestroyed);
        }
        ...
        private void OnClanChangedKingdom(Clan clan, Kingdom oldKingdom, Kingdom newKingdom, ChangeKingdomAction.ChangeKingdomActionDetail detail, bool showNotification)
        {
            ...
            {
                alliance.AddHistoryEntry($"{clan.Name} changed from {oldKingdom?.Name ?? "no kingdom"} to {newKingdom?.Name ?? "no kingdom"}");
